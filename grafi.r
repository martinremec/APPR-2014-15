...
barplot(d, beside=T, main='Refined Petroleum imprts & exports in 2011', xlab ='Country', ylab ='Refined_Petroleum_export_Thousand_Barrels_Per_Day', col =c('purple','deeppink'), legend=c('Refined Petroleum Exports','Refined Petroleum Imports'), xlim = c(0, 15), args.legend = c(x="topleft"))
dev.off()
...
barplot(b, beside=T, main='Refined Petroleum imprts & exports in 2012', xlab ='Country', ylab ='Refined_Petroleum_export_Thousand_Barrels_Per_Day', col =c('purple','deeppink'), legend=c('Refined Petroleum Exports','Refined Petroleum Imports'), xlim = c(0, 15), args.legend = c(x="topleft"))
dev.off()
